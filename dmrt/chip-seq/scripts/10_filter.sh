...
# Retain only high-quality mapped reads (MAPQ >= 30) and remove unmapped, secondary, and supplementary alignments
# Also remove reads mapped to mtDNA and unplaced contigs (chrM, chrUn_*, chrEBV)
